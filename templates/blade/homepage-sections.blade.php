...
{{--        </div>--}}
{{--        {{do_shortcode('[recent-tools]')}}--}}
{{--        <a href="{{do_shortcode('[link path="/tools"]')}}" class="view-more__link">>> view more</a>--}}
{{--        <hr>--}}
{{--    </div>--}}

{{--    <div class="container tabs-and-commonly-searched__container">--}}
{{--        <h2><span class="highlight">Categories</span> of tools</h2>--}}
{{--        <p class="subtitle">We sort our tools into a wide range of <strong>categories</strong> so that users can quickly and easily access relevant tools.</p>--}}
{{--        <div class="subheading">--}}
{{--            Most searched categories:--}}
{{--        </div>--}}
{{--        {{do_shortcode('[top-tools-by-categories]')}}--}}
{{--    </div>--}}
{{--    <div class="button-container">--}}
{{--        <a class="show-more__btn" href="<{{do_shortcode('[link path="/category"]')}}">more categories</a>--}}
{{--    </div>--}}
...
{{--                Top Tasks:--}}
{{--            </div>--}}
{{--            {{do_shortcode('[tools-by-top-tasks]')}}--}}
{{--        </div>--}}
{{--    </div>--}}
{{--</section>--}}
...
{{--                Top Solutions:--}}
{{--            </div>--}}
{{--            {{do_shortcode('[tools-by-top-solutions]')}}--}}
{{--        </div>--}}
{{--    </div>--}}
{{--</section>--}}
