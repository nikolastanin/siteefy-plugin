...
<div class="content">
    <div class="container">
        ...
        <h2 class="text-blue"><span class="highlight"><?php echo ucfirst($post->post_title) . ' Tools'?></span></h2>
        ...
        <div class="search-results__container extra-margin">
            ...
            foreach ($grouped_tools as $solution_data) {
                ...
                foreach ($tools as $tool) { ?>
                    <div class="tool-item" data-link="<?php echo siteefy_get_field('tool_review_link', $tool->ID); ?>">
                        <div class="tool-item__inner">
                            <div class="tool-item__img">
                                <img src="<?php echo siteefy_get_field('tool_image', $tool->ID); ?>" alt="">
                            </div>
...
<!--                                    todo: this needs to be changes on all templates-->
                    ...
                    <?php
                    $tool_index++; // Increment the tool index (e.g., a, b, c)
                }
                $solution_index++; // Increment the solution index (e.g., 1, 2, 3)
            }
            ?>
