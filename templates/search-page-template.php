...
<div class="content">
    <div class="container">
        ...
        <h2 class="text-blue"><span class="highlight">
            <?php
            $search_term = $_GET['s'];
            echo ucfirst($search_term);
            $filtered_tools = get_tools_by_search_term();
            $tools = get_featured_and_non_featured_tools_from_tools_list($filtered_tools);
            ?>
        </span>
        </h2>
        <?php if(count($tools->featured_tools)>0): ?>
        <div class="heading-container">
            <h3 class="text-gray w-700">Featured</h3>
            <div class="line-container"><span class="line"></span></div>
        </div>
        <div class="search-results__container">
            <?php
            foreach ($tools->featured_tools as $tool){?>
                <div class="tool-item featured col-3" data-link="<?php siteefy_get_field('tool_review_link', $tool->ID); ?>">
        ...
        <?php endif;?>
        <div class="heading-container">
            <h3 class="text-gray w-700">Matches found</h3>
            <div class="line-container"><span class="line"></span></div>
        </div>
        <div class="search-results__container">
            <?php
            if(count($tools->non_featured_tools)>0):
            foreach ($tools->non_featured_tools as $tool){?>
                <div class="tool-item col-3" data-link="<?php siteefy_get_field('tool_review_link', $tool->ID); ?>">
                    <div class="tool-item__inner">
                        <div class="tool-item__img">
                            <img src="<?php siteefy_get_field('tool_image', $tool->ID); ?>" alt="">
                        </div>
